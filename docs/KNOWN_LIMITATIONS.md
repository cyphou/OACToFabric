...
| D-6 | Cognos and Qlik connectors are stubs only | 🔴 | Use T2P project for Tableau; manual migration for Cognos/Qlik until Phase 41+ |
...
| P-4 | Cognos and Qlik connectors are stubs | 🔴 | Planned for v4.0 Phase 41+ |
